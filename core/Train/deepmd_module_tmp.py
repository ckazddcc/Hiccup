...
class DeepmdSystem:
    ...
    def _split_db_to_train_valid(self):
        ...
        train_db = connect("/home/cchen/CuY/supply_test/data/75/train.db")
        test_db = connect("/home/cchen/CuY/supply_test/data/75/value.db")
...
if __name__ == '__main__':
    dp = DeepmdSystem(elements=["O", "Cu", "Y"],
                      db_path="./merged.db",
                      train_ratio=0.9,
                      workdir="/home/cchen/CuY/supply_test/deepmd/75",
                      gpu=[2],
                      dp_input_template="/home/cchen/CuY/hiccup2/template/trainer/deepmd_input.json",
